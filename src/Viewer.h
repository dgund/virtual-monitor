/*
    Viewer.h
    Displays frames for color, depth, and infrared.
    Uses code from OpenKinect demo.
*/
...
#define VIEWER_FRAME_COLOR "VIEWER_FRAME_COLOR"
#define VIEWER_FRAME_DEPTH "VIEWER_FRAME_DEPTH"
#define VIEWER_FRAME_INFRARED "VIEWER_FRAME_INFRARED"
#define VIEWER_FRAME_REGISTERED "VIEWER_FRAME_REGISTERED"
